...
//   // 执行查重操作
//   db.query(sqlStr1, [req.body.name, req.body.alias], function (err, results) {
//     // 执行 SQL 语句失败
//     if (err) {
//       return res.cc(err);
//     }
...
//     db.query(sqlStr2, req.body, function (err, results) {
//       // SQL 语句执行失败
//       if (err) {
//         return res.cc(err);
//       }
...
//   db.query(sqlStr1, [req.body.Id, req.body.name, req.body.alias], function (err, results) {
//     // 执行 SQL 语句失败
//     if (err) {
//       return res.cc(err);
//     }
